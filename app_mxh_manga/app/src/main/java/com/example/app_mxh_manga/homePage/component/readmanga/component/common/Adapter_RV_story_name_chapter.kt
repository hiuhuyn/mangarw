...
class Adapter_RV_story_name_chapter(val list: ArrayList<Story_Get>): RecyclerView.Adapter<Adapter_RV_story_name_chapter.StoryItemHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): StoryItemHolder {
        return StoryItemHolder(LayoutInflater.from(parent.context).inflate(R.layout.item_story_name_chapter, parent, false))
    }
